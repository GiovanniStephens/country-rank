...
def reduce_dimensions_pca(embeddings: List[List[float]],
...
def reduce_dimensions_umap(embeddings: List[List[float]],
                           dimensions: int = 80,
...
def single_sample_t_test(sample: np.array,
...
def get_optimal_n_components(embeddings: List[List[float]],
...
def kmeans_clustering(reduced: List[List[float]],
                      num_clusters: int = -1,
...
def hdbscan_clustering(reduced: List[List[float]],
