...
if __name__ == '__main__':
    scrape_index('https://www.numbeo.com/pollution/rankings_by_country.jsp', ['Country', 'Pollution Index'])
    scrape_index('https://www.numbeo.com/health-care/rankings_by_country.jsp', ['Country', 'Health Care Index'])
    scrape_index('https://www.numbeo.com/crime/rankings_by_country.jsp', ['Country', 'Crime Index', 'Safety Index'])